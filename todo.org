...
** DONE régler le problème de non affichage des erreurs dans les events
   CLOSED: [2015-06-21 dim. 17:06]
   l’évènement n’était pas appelé
** DONE régler le problème de non-héritage de catégories
   CLOSED: [2015-06-21 dim. 17:07]
   l’évènement n’était pas appelé
** DONE faire que les boutons ne cache pas le bas des recherches
   CLOSED: [2015-06-21 dim. 17:20]
** TODO methode de suppression rapide des concepts
** TODO utiliser le logiciel pour la maison jusqu’à détection du big bug
** TODO correction du big bug
